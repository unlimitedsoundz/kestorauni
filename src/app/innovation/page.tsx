...
export const metadata = {
    title: 'Innovation Hub — Heffring University | Startups, Incubation & Entrepreneurship',
    description: 'Heffring University Innovation Hub connects students, researchers, and industry to turn ideas into impact. Startup incubation, workshops, and entrepreneurship support.',
    alternates: {
        canonical: 'https://heffring.online/innovation/',
    },
};
