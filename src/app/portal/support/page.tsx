    ...
    const supportChannels = [
        {
            ...
            title: "Email Support",
            value: "it.support@heffring.online",
            desc: "Primary channel for all technical inquiries.",
            link: "mailto:it.support@heffring.online"
        },
        {
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="bg-neutral-100 p-8 rounded-sm">
                                ...
                                <p className="text-neutral-600 text-sm leading-relaxed">
                                    Heffring University IT department will never ask for your password via email or phone. Always use official login portals to access your accounts.
                                </p>
                            </div>
                        </div>
